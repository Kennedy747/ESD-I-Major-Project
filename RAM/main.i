...
int percentageHumidity(void){
	...
	return (((ADC_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2200U))->DR / 255) * 100;
}
...
void incrementClock(void){
	...
	{
		((TIM_TypeDef *) (0x40000000U + 0x1000U))->CNT++;
	} else {
		((TIM_TypeDef *) (0x40000000U + 0x1000U))->SR |= (0x1U << (0U));
...
void buttonCHECK()
{
	...
	if((FanPressed || LightPressed || BothPressed) == 1)
	{
		...
		if(((((TIM_TypeDef *) (0x40000000U + 0x1400U))->SR & (0x1U << (0U))) == 1) && countVALUE == 100)
		{
...
void setTIM7()
{
	...
	((TIM_TypeDef *) (0x40000000U + 0x1400U))->ARR |= 0x79E0; 
...
void configureGPIOPins(void) {
	...
	portConfig.port = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U));
	portConfig.pin = Pin0;
	...
	portConfig.port = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U));
	...
	portConfig.port = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U));
	portConfig.pin = Pin10;
...
void configureADC1(void){
	...
	((ADC_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2200U))->CR1 &= ~(((0x1U << (8U))) | (0x02 << (24U)));
...
void init(void){
	...
	((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR |= (0x1U << (4U)) | (0x1U << (18U));
	((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR |= (0x1U << (4U)) | (0x1U << (18U));
	__asm("NOP");
	__asm("NOP");
	((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR &= ~((0x1U << (4U))) & ~((0x1U << (18U)));
	__asm("NOP");
	...
	__asm("NOP");
	__asm("NOP");	
	((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR &= ~((0x1U << (5U)));
	__asm("NOP");
	__asm("NOP");
	
	
	((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR = ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR | (0x1U << (0U)) | (0x1U << (1U)) | 
	(0x1U << (5U));
	((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1RSTR = ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1RSTR | (0x1U << (0U)) | (0x1U << (1U)) | 
	(0x1U << (5U));
	__asm("NOP");
	__asm("NOP");
	((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1RSTR = ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1RSTR & ~((0x1U << (0U))) 
	& ~((0x1U << (1U))) & ~((0x1U << (5U)));
	__asm("NOP");
	__asm("NOP");
